                  ...
                  <div className="space-y-6 max-h-[70vh] overflow-y-auto pr-2">
                    ...
                    <div className="p-4 border rounded-xl shadow-sm bg-purple-50">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div className="flex flex-col">
                          <label className="font-medium mb-1 text-purple-700">
                            Harga Setelah Diskon (Opsional)
                          </label>
                          <input
                            type="number"
                            className="border rounded px-3 py-2 focus:ring-2 focus:ring-purple-400 focus:outline-none"
                            ...
                            onChange={(e) => {
                              ...
                              const newDiscountPrice =
                                selected.price && percentDiscount
                                  ? selected.price -
                                    (selected.price * percentDiscount) / 100
                                  : selected.price;
                              setSelected({
                                ...selected,
                                percentDiscount,
