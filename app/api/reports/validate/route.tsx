...
validatedAt: validationTime,
    ...
    const updatedResult =
  source === "personalityResult"
    ? await prisma.personalityResult.findUnique({
        where: { id: reportId },
        include: {
          User: true,
          ValidatedBy: true,
...
const qrCodeBase64 = updatedResult?.barcode
  ? await QRCode.toDataURL(
      `https://f321-2400-9800-309-3e03-e9e2-a232-78d9-2e4a.ngrok-free.app/validate/${updatedResult.barcode}`
    )
  : undefined;
const pdfStream = await pdf(
<ReportCPMIDocument
  attempt={updatedResult as any}
  result={updatedResult as any}

  kesimpulan={
    updatedResult?.kesimpulan ?? undefined
  }
...
//   normalizedPdfText
// );
const savedPdfBuffer =
  fs.readFileSync(filePath);

const dataHash = crypto
  .createHash("sha512")
  .update(savedPdfBuffer)
  .digest("hex");

console.log("SIGN PDF HASH:", dataHash);
    // =============================
...
// const canonicalPdfData = {
//   pdfText: normalizedPdfText,
// };

// const canonicalString =
//   stableStringify(canonicalPdfData);

// const dataHash = crypto
//   .createHash("sha512")
//   .update(canonicalString || "")
//   .digest("hex");
  console.log("SIGN HASH:", dataHash);
...
// const qrCodeBase64 = result.barcode
//   ? await QRCode.toDataURL(
//       `https://3fcf-2001-448a-2020-5a6-172-2549-cda5-6f91.ngrok-free.app/validate/${result.barcode}`
//     )
//   : undefined;
// const pdfStream = await pdf(
// <ReportCPMIDocument
