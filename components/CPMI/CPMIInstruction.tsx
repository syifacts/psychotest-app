...
const CPMIInstruction: React.FC<Props> = ({
  exampleQuestions,
  onFinishExamples,
}) => {
        ...
        <div className="bg-white/90 backdrop-blur-sm border border-blue-100 rounded-2xl shadow-xl p-8 mt-15">
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  mencakup berbagai jenis pertanyaan yang harus diselesaikan
                  tanpa alat bantu seperti kalkulator atau alat sejenis. Bacalah
                  dengan seksama petunjuk dan kerjakanlah contoh pertanyaan.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-blue-700 mb-1">
                  Petunjuk (Bacalah dengan seksama)
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  Tes ini berisi 50 pertanyaan yang secara bertahap menjadi
                  semakin sulit. Anda tidak mungkin dapat menyelesaikan semua
                  pertanyaan, tetapi selesaikan semampu Anda. Setelah petugas
                  tes meminta Anda untuk mulai, Anda memiliki waktu 12 menit
                  untuk memberi jawaban yang benar sebanyak mungkin. Kerjakan
                  dengan teliti, namun jangan menghabiskan waktu lama pada
                  setiap pertanyaan atau lewati pertanyaan itu. Pastikan Anda
                  menulis jawaban pada tanda kurung yang tersedia. Sebelum Anda
                  memulai tes ini, bacalah contoh pertanyaan di bawah ini.
                </p>
